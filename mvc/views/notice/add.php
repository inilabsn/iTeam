        ...
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <div class="box-header">
                    ...
                    <h3 class="box-title">Notice form</h3>
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        ?>
                            ...
                            <div class="col-sm-5">
                                ...
                                <textarea class="form-control textarea" placeholder="Enter ..." rows="3" id="notice" name="notice" value="<?=set_value('notice')?>"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-2 col-sm-8">
                                ...
                                <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_notice")?>" >
