                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php if(form_error('date')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="date" name="date" value="<?=set_value('date', $timetracker->date)?>" >
                            </div>
                            <span class="col-sm-4 control-label">
                        ...
                        <div class="form-group <?php if(form_error('hour')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="hour" name="hour" value="<?=set_value('hour', $timetracker->timehour)?>" >
                            </div>
                            <span class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-5">
                                <?php
                                    if(count($tasks)) {
                                        ...
                                        echo form_dropdown("taskID", $array, set_value("taskID", $timetracker->taskID), "id='taskID' class='form-control'");
                                    } else { ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-8">
                                <input type="submit" class="btn btn-success" value="<?=$this->lang->line("edit_timetracker")?>" >
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    if(parseInt(id)) {
        if(id === '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('timetracker/task_return')?>",
                data: {"id" : id},
                dataType: "html",
