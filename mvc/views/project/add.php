                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php if(form_error('project_title')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="project_title" name="project_title" value="<?=set_value('project_title')?>" >
                            </div>
                        ...
                        <div class="form-group <?php if(form_error('project_create_date')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="project_create_date" name="project_create_date" value="<?=set_value('project_create_date')?>" data-date-format="yyyy-mm-dd">
                            </div>
                            <span class="col-sm-4 control-label">
                        ...
                        <div class="form-group <?php if(form_error('project_deadline')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="project_deadline" name="project_deadline" value="<?=set_value('project_deadline')?>" data-date-format="yyyy-mm-dd">
                            </div>
                            <span class="col-sm-4 control-label">
                        ...
                        <div class="form-group <?php if(form_error('project_description')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control textarea" placeholder="Enter ..." rows="3" id="project_description" name="project_description" value="<?=set_value('project_description')?>"></textarea>
                            </div>
                            <span class="col-sm-4 control-label">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-8">
                                <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_project")?>" >
                            </div>
                        </div>
                    </form>
                </div>
