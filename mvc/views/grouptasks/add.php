                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php if(form_error('group_name')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="group_name" name="group_name" value="<?=set_value('group_name')?>" >
                            </div>
                            ...
                            <div class="col-sm-5">
                                <select name="tasks[]" multiple class="form-control">
                                  <?php foreach ($tasks as $task): ?>
                                      <option value="<?=$task->task_id?>"><?=$task->task_title?></option>
                                  <?php endforeach ?>
                                </select>                        
                            </div>
                        ...
                        <div class="form-group <?php if(form_error('description')) echo "has-error"?>">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control textarea" placeholder="Enter ..." rows="3" id="description" name="description" value="<?=set_value('description')?>"></textarea>
                            </div>
                            <span class="col-sm-4 control-label">
