...
class CI_Cart {
	...
	function _insert($items = array())
	{
		...
		if ( ! isset($items['id']) OR ! isset($items['qty']) OR ! isset($items['price']) OR ! isset($items['p_name']))
		{
		...
		if ( ! preg_match("/^[".$this->product_name_rules."]+$/i", $items['p_name']))
		{
			log_message('error', 'An invalid name was submitted as the product name: '.$items['p_name'].' The name can only contain alpha-numeric characters, dashes, underscores, colons, and spaces');
			return FALSE;
		}
